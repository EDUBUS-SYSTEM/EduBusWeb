  ...
  return (
    <>
      ...
      <button
        ...
        className="lg:hidden fixed top-4 left-4 z-50 bg-[#fad23c] text-[#463B3B] p-2 rounded-md shadow-md hover:bg-[#FFF085] transition-colors"
      ...
      {/* Sidebar */}
      <aside className={`
        bg-[#FEFCE8] w-64 h-screen flex flex-col fixed left-0 top-0 shadow-md z-50
