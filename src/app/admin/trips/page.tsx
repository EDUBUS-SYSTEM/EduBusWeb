          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-6 md:mb-8">
            <div className="bg-white rounded-2xl shadow-soft-lg p-4 md:p-6 border border-gray-100">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-xs md:text-sm font-medium text-gray-600">Total Trips Today</p>
                  <p className="text-xl md:text-2xl font-bold text-[#463B3B]">12</p>
                </div>
            ...
            <div className="bg-white rounded-2xl shadow-soft-lg p-4 md:p-6 border border-gray-100">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xl md:text-2xl font-bold text-[#463B3B]">8</p>
                </div>
            ...
            <div className="bg-white rounded-2xl shadow-soft-lg p-4 md:p-6 border border-gray-100">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-xs md:text-sm font-medium text-gray-600">Students Transported</p>
                  <p className="text-xl md:text-2xl font-bold text-[#463B3B]">245</p>
                </div>
            ...
            <div className="bg-white rounded-2xl shadow-soft-lg p-4 md:p-6 border border-gray-100">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-xs md:text-sm font-medium text-gray-600">On-time Performance</p>
                  <p className="text-xl md:text-2xl font-bold text-[#463B3B]">94%</p>
                </div>
                <div className="w-10 h-10 md:w-12 md:h-12 bg-gradient-to-r from-cyan-400 to-cyan-500 rounded-xl flex items-center justify-center">
                  <svg className="w-5 h-5 md:w-6 md:h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-4 md:p-6 max-h-[90vh] overflow-y-auto">
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  type="text"
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#fad23c] focus:border-transparent text-sm md:text-base"
              ...
              <div>
                ...
                <select className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#fad23c] focus:border-transparent text-sm md:text-base">
            ...
            <div className="flex flex-col sm:flex-row justify-end gap-2 sm:gap-3 mt-6">
              ...
              <button className="px-4 py-2 bg-gradient-to-r from-[#fad23c] to-[#FDC700] text-[#463B3B] rounded-lg hover:from-[#FDC700] hover:to-[#D08700] transition-all duration-300 font-semibold text-sm md:text-base">
                Create Trip
              </button>
            </div>
          </div>
