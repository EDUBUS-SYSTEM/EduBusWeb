...
export default function CalendarSamplesPage() {
  ...
  const sampleData = {
    week: {
      ...
      events: mockCalendarEvents.filter(
        (e) =>
    ...
    day: {
      ...
      events: mockCalendarEvents.filter(
        (e) => e.start.toDateString() === new Date(2024, 8, 10).toDateString()
      ),
    },
  };
      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-gray-600 text-lg">
            Explore different calendar layouts and designs for EduBus scheduling
            system
          </p>
        </div>
        ...
        <div className="mb-8">
          <div className="bg-white rounded-2xl shadow-soft-lg p-6 border border-gray-100 mb-6">
            ...
            <p className="text-gray-600 mb-4">{currentSample.description}</p>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-soft-lg p-6 border border-gray-100">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <p className="text-gray-700">
                  Gentle shadows and hover effects
                </p>
              </div>
              <div className="flex items-center space-x-3">
                <div className="w-6 h-6 rounded-full bg-green-100 flex items-center justify-center">
              ...
              <div className="flex items-center space-x-3">
                ...
                <p className="text-gray-700">
                  Pastel gradients and soft colors
                </p>
              </div>
              <div className="flex items-center space-x-3">
                <div className="w-6 h-6 rounded-full bg-green-100 flex items-center justify-center">
